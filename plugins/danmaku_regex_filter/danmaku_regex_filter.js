...
var rules = [
  ...
  },
  {
    id: 'date',
    name: '日期考古',
    desc: '各类日期格式弹幕（2026.04.12、2026-04-12、20260412、2026.0412、2026年4月12日）及"考古/留名"等',
    pattern: '^(?:\\d{2,4}[./-]\\d{1,2}[./-]\\d{1,2}|\\d{4}[./-]\\d{3,4}|\\d{4}[./-]\\d{1,2}|\\d{8}|\\d{4}年\\d{1,2}月(?:\\d{1,2}日?)?|\\d{2,4}[^]{0,10}?(?:路过|考古|留名|报[到道]|到此一游))$/',
    enabled: true
  },
  {
    id: 'anyone',
